...
public class IncrementalMultiplatformJvmCompilerRunnerTestGenerated extends AbstractIncrementalMultiplatformJvmCompilerRunnerTest {
    ...
    public void testTouchActual() throws Exception {
        String fileName = KotlinTestUtils.navigationMetadata("jps-plugin/testData/incremental/multiplatform/singleModule/touchActual/");
        doTest(fileName);
    }

    @TestMetadata("touchExpect")
    public void testTouchExpect() throws Exception {
        String fileName = KotlinTestUtils.navigationMetadata("jps-plugin/testData/incremental/multiplatform/singleModule/touchExpect/");
        doTest(fileName);
    }
}
